                ...
                audit.timelinesApproved && (
                  ...
                  >
                    <div>
                      ...
                      >
                        Pre-engagement activities are complete and timelines are
                        approved.
                      </div>
                    </div>
                    <button
                      className={s.btnPrimary}
                      onClick={() => {
                        updateAuditStatus(audit.id, "Planning");
                        addToast({
                          type: "success",
                          title: "Phase Advanced",
                          message: `${lga?.name || audit.lgaId} has been moved to Planning.`,
                        });
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          ...
          <div>
            ...
            <p className={s.pageSubtitle}>
              {audit.status} Stage • Lead:{" "}
              {users.find((u) => u.id === audit.leadId)?.name || "Unassigned"}
            </p>
          </div>
        </div>
        <StatusBadge label={audit.status} />
