...
const fmtCurrency = (n: number) =>
  `â‚¦${n.toLocaleString("en-NG", { maximumFractionDigits: 0 })}`;
...
const TrialBalanceUpload: React.FC<TrialBalanceUploadProps> = ({
  ...
  return (
    <div>
      {!hasData && (
        ...
        >
          ...
          <div style={{ fontSize: "0.72rem", color: "#94a3b8" }}>
            Expected columns: NCOA Code Â| Account Â| {currentYear} Â| {priorYear}
          </div>
          {parsing && (
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: "0.75rem", color: "#166534" }}>
                {existing.lines.length} account lines parsed Â| Uploaded{" "}
            ...
            >
              ...
              >
                <tr>
                  ...
                  <th style={{ ...th, textAlign: "right" }}>{priorYear} (â‚¦)</th>
              ...
              <tbody>
                {existing.lines.slice(0, 200).map((line) => (
                  <tr key={line.id}>
                    <td style={td}>{line.ncoaCode || "â€”"}</td>
      ...
      {/* Silence unused-vars â€” kept for API parity */}
      {fileName && null}
      {previewParse && null}
    </div>
  );
