...
const CURATED_AUDITS: Audit[] = [
  ...
  },
  {
    ...
    status: "Fieldwork",
    mandateId: "mandate-1",
    leadId: "user-jide-johnson",
    teamIds: ["user-auditor-7", "user-auditor-9"],
    startDate: "2026-03-10",
    endDate: "2026-09-30",
    phaseTimelines: {
      Engagement: { startDate: "2026-03-10", endDate: "2026-03-20" },
...
// Combine curated + generated. Every audit lead (curated, primary-LGA, and
// bench) is guaranteed to have at least one audit assigned to them through
// GENERATED_AUDITS — see generatedData.ts for lead-to-audit mapping.
export const SEED_AUDITS: Audit[] = [...CURATED_AUDITS, ...GENERATED_AUDITS];
